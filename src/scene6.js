...
export class TittaScene extends Scene {
  ...
  makeAnimate() {
    ...
    //shearing
    this.addKeyframe(this.fecus1Top, 6000, anim.shearx, fn.SIGMOID, 0.5, 370);
    ...
    this.addKeyframe(this.fecus2Top, 6000, anim.shearx, fn.SIGMOID, -0.12, 220);
    ...
    this.addKeyframe(this.fecus3, 6000, anim.sheary, fn.SIGMOID, -1, 318);
